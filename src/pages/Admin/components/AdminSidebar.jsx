...
const sidebarModules = [
  ...
  { title: "FAQs", path: "/admin/faqs", icon: HelpCircle, active: true },
  { title: "CMS", path: "/admin/cms", icon: FolderKanban, active: true },
  { title: "Media", path: "/admin/media", icon: Image, active: true },
