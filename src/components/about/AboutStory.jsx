            ...
            <div className="flex flex-col">
              ...
              <Reveal direction="up" delay={0.3}>
                <p className="text-gray-700 font-sans text-base sm:text-lg leading-relaxed mb-3 font-medium">
                  ...
                  built around the real-world requirements of the commercial
                  enterprises, facilities, and communities we protect.
                </p>
                <p className="text-gray-600 font-sans text-base leading-relaxed mb-6">
                  From professional armed and unarmed security guards to
                  specialized data center protection, cybersecurity oversight,
                  and mobile patrols, our approach combines experienced security
                  personnel, disciplined post orders, and modern surveillance
                  technology.
                </p>
              </Reveal>

              {/* Credibility Checklist */}
              <div className="flex flex-col gap-3 mb-8 capitalize">
                <Reveal direction="up" delay={0.4}>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-neutral-light border border-neutral-border">
                    ...
                    />
                    <span className="text-domenion-blue font-heading text-sm font-bold">
                      Professional, state-licensed security officers
                    </span>
                  </div>
                </Reveal>
                ...
                <Reveal direction="up" delay={0.5}>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-neutral-light border border-neutral-border">
                    ...
                    />
                    <span className="text-domenion-blue font-heading text-sm font-bold">
                      Integrated physical guarding, access control & monitoring
                    </span>
                  </div>
                </Reveal>
                ...
                <Reveal direction="up" delay={0.6}>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-neutral-light border border-neutral-border">
                    ...
                    />
                    <span className="text-domenion-blue font-heading text-sm font-bold">
                      24/7 rapid emergency dispatch & operational readiness
                    </span>
                  </div>
                </Reveal>
              </div>
