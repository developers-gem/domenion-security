          ...
          <div className="lg:col-span-5">
            <Reveal direction="up" delay={0.2}>
              <p className="text-gray-600 font-sans text-base sm:text-lg leading-relaxed">
                Explore Domenion Security's full portfolio of 14 core protection
                capabilities. Each service is tailored to your facility's
                operational risks and regulatory standards.
              </p>
            </Reveal>
          </div>
        </div>
            ...
            <div key={service.slug} className="h-full flex flex-col">
              ...
              >
                <Link
                  ...
                  className="bg-neutral-light border border-neutral-border hover:border-domenion-gold/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 group text-decoration-none flex items-center justify-between gap-6 h-full flex-1"
                >
