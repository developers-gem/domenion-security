            ...
            <div className="flex flex-col">
              ...
              <Reveal direction="up" delay={0.2}>
                <p className="text-gray-600 font-sans text-base sm:text-lg leading-relaxed mb-4">
                  Every environment presents distinct operational threats,
                  access control challenges, and regulatory compliance
                  standards. Domenion Security delivers customized defense
                  solutions tailored to your organization.
                </p>
                <p className="text-gray-600 font-sans text-base leading-relaxed">
                  Combining trained security officers, advanced surveillance
                  monitoring, mobile patrols, and enterprise cybersecurity, our
                  integrated approach ensures total operational preparedness.
                </p>
              </Reveal>
