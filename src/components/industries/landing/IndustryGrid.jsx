...
export default function IndustryGrid() {
  return (
    <section className="py-20 sm:py-28 bg-white text-domenion-blue border-b border-neutral-border" id="all-industries">
      <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end mb-12">
          <div className="lg:col-span-7">
            <Reveal direction="up">
              <span className="inline-flex items-center gap-2 text-domenion-gold font-heading text-xs font-extrabold tracking-widest uppercase">ALL PROTECTED INDUSTRIES</span>
            </Reveal>

            <Reveal direction="up" delay={0.1}>
              <h2 className="text-domenion-blue font-heading text-3xl sm:text-4xl font-extrabold tracking-tight mt-2 leading-tight">
                Browse security by <span className="text-domenion-gold">facility & industry type.</span>
              </h2>
            </Reveal>
          </div>
                ...
                >
                  ...
                  <div className="absolute inset-0 p-6 flex flex-col justify-between text-white z-10">
                    ...
                    <div className="flex flex-col">
                      <h3 className="text-white font-heading text-xl font-bold group-hover:text-domenion-gold transition-colors mb-1">{ind.title}</h3>
