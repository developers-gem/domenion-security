...
const PRIORITIES_DATA = [
  {
    ...
    desc: "Verifying credentials, visitor logs, and perimeter entry points across all shift hours.",
  },
  {
    num: "02",
    title: "PEOPLE & ASSET PROTECTION",
    desc: "Safeguarding employees, visitors, patients, residents, and high-value physical inventory.",
  },
  {
    num: "03",
    title: "THREAT AWARENESS",
    desc: "Continuous surveillance monitoring and proactive risk detection before breaches occur.",
  },
  {
    num: "04",
    title: "OPERATIONAL CONTINUITY",
    desc: "Mitigating security interruptions to keep essential facility operations running smoothly.",
  },
  {
    num: "05",
    title: "SITE SECURITY",
    desc: "Routine perimeter checks, vehicle patrols, and secure keyholding procedures.",
  },
  {
    num: "06",
    title: "RESPONSE READINESS",
    desc: "24/7 emergency dispatch and standardized incident escalation protocols.",
  },
];
          ...
          <div className="lg:col-span-5">
            <Reveal direction="up" delay={0.2}>
              <p className="text-gray-600 font-sans text-base sm:text-lg leading-relaxed">
                Regardless of industry type, Domenion Security structures every
                operational program around 6 core security pillars.
              </p>
            </Reveal>
          </div>
        </div>
              ...
              >
                <div className="bg-white border border-neutral-border hover:border-domenion-gold/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full group">
                  <div className="flex items-center justify-between pb-3 mb-3 border-b border-neutral-border">
                    ...
                    <h3 className="text-domenion-blue font-heading text-sm font-bold tracking-wider">
                      {item.title}
                    </h3>
                  </div>
