          ...
          <div className="lg:col-span-7">
            ...
            <Reveal direction="up" delay={0.1}>
              <h2 className="text-domenion-blue font-heading text-3xl sm:text-4xl font-extrabold tracking-tight mt-2 leading-tight capitalize">
                Choose the way that{" "}
                <span className="text-domenion-gold">works best for you.</span>
              </h2>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-5">
            <Reveal direction="up" delay={0.2}>
              <p className="text-gray-600 font-sans text-base sm:text-lg leading-relaxed">
                Whether you need an immediate security quote, 24/7 dispatch
                support, or an initial operational consultation, we are here to
                assist.
              </p>
            </Reveal>
          </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <h3 className="text-domenion-blue font-heading text-base font-bold mb-2 uppercase">
                        {item.title}
                      </h3>
