          ...
          <div className="lg:col-span-7">
            ...
            <Reveal direction="up" delay={0.1}>
              <h2 className="text-domenion-blue font-heading text-3xl sm:text-4xl font-extrabold tracking-tight mt-2 leading-tight capitalize">
                Work that matters.{" "}
                <span className="text-domenion-gold">A team that cares.</span>
              </h2>
            </Reveal>
          </div>
          ...
          <div className="lg:col-span-5">
            <Reveal direction="up" delay={0.2}>
              <p className="text-gray-600 font-sans text-base sm:text-lg leading-relaxed">
                Security is built on people. We value professionalism,
                responsibility, situational awareness, and a commitment to doing
                the job right.
              </p>
            </Reveal>
          </div>
                ...
                <div className="bg-neutral-light border border-neutral-border hover:border-domenion-gold/50 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between h-full group">
                  <div>
                    <div className="flex items-center justify-between pb-3 mb-3 border-b border-neutral-border">
                      ...
                      <h3 className="text-domenion-blue font-heading text-base font-bold uppercase">
                        {row.title}
                      </h3>
                    </div>
