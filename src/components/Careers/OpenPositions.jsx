...
//     } catch {
//       setJobsError(
//         "Unable to load current career opportunities. Please check back soon.",
//       );
//     } finally {
...
//                 Explore current opportunities with Domenion Security. Select any
//                 role to view position details and submit your application.
//               </p>
//             </Reveal>
//           </div>
//         </div>
...
//             <Loader2
//               size={32}
//               className="animate-spin text-domenion-gold mb-3 mx-auto"
//             />
//             <p className="text-gray-500 text-sm font-medium">
//               Loading open career opportunities...
//             </p>
//           </div>
//         ) : jobsError ? (
...
//               <Briefcase size={28} />
//             </div>
//             <h3 className="text-domenion-blue font-heading text-xl font-extrabold mb-2">
//               NO CURRENT OPENINGS
//             </h3>
//             <p className="text-gray-600 text-sm leading-relaxed mb-6">
//               We don't have any open positions listed right now. Please check
//               back soon or submit a general inquiry to our recruitment team.
//             </p>
//             <Link
//               to="/contact"
...
//                   <div
//                     className={`bg-neutral-light border border-neutral-border rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between h-full group ${isClosed ? "opacity-60" : ""}`}
//                   >
//                     <div>
//                       {/* Card Header */}
...
//                         </span>
//                         <span
//                           className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-heading font-extrabold ${
//                             isClosed
...
//                         >
//                           <span
//                             className={`w-1.5 h-1.5 rounded-full ${isClosed ? "bg-gray-500" : "bg-emerald-500"}`}
//                           />
...
//                         <Link
//                           to={`/careers/${job._id}`}
//                           className="text-domenion-blue hover:text-domenion-gold text-decoration-none"
//                         >
//                           {job.title}
//                         </Link>
//                       </h3>
        ...
        {loadingJobs ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-stretch">
            {filteredJobs.map((job, idx) => {
              ...
              return (
                <div key={job._id || idx} className="h-full flex flex-col">
                  <Reveal
                    direction="up"
                    delay={0.05 * idx}
                  ...
                  >
                    <div
                      className={`bg-neutral-light border border-neutral-border rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col flex-1 h-full group ${isClosed ? "opacity-60" : ""}`}
                    >
                      <div className="flex flex-col flex-1">
                        ...
                        <div className="border-t border-neutral-border my-4 mt-auto" />
                      ...
                      {/* Card Footer Buttons */}
                      <div className="grid grid-cols-2 gap-3 pt-4 border-t border-neutral-border mt-auto">
                        <Link
                          to={`/careers/${job._id}`}
                          className="inline-flex items-center justify-center gap-1 py-2.5 bg-white border border-neutral-border rounded-lg text-domenion-blue text-xs font-heading font-bold hover:bg-neutral-light transition-colors text-decoration-none"
                        >
