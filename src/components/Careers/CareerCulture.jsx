            ...
            <div className="flex flex-col">
              ...
              <Reveal direction="up" delay={0.2}>
                <p className="text-gray-700 font-sans text-base sm:text-lg leading-relaxed mb-3 font-medium">
                  Every successful security operation depends on professionals
                  who are alert, prepared, and committed to their post orders.
                </p>
                <p className="text-gray-600 font-sans text-base leading-relaxed">
                  At Domenion Security, our people are at the center of
                  everything we protect. We support our security personnel with
                  clear post operational guidelines, continuous readiness
                  oversight, and strong leadership.
                </p>
              </Reveal>
            </div>
          </div>
