              ...
              <div className="flex flex-col">
                ...
                <Reveal direction="up" delay={0.2}>
                  <p className="text-white/85 text-base sm:text-lg leading-relaxed mb-8 max-w-lg">
                    Explore current opportunities and find a role where your
                    skills, responsibility, and dedication can make a real
                    difference.
                  </p>
                </Reveal>
                ...
                <Reveal direction="up" delay={0.3}>
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <Button to="/contact" variant="gold-outline" size="lg">
                      Contact Domenion
                    </Button>
                  </div>
                </Reveal>
