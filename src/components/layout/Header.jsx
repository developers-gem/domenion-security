...
//               <strong className="text-white font-heading text-base sm:text-lg lg:text-xl font-extrabold tracking-wider">
//                 DOMENION
//               </strong>
//               <small className="text-domenion-gold font-heading text-[9px] sm:text-[10px] lg:text-[11px] font-bold tracking-[0.22em] mt-0.5">
//                 SECURITY
//               </small>
//             </div>
//           </Link>
...
//           {/* ================= DESKTOP NAV ================= */}
//           <nav
//             className="hidden lg:flex items-center gap-x-6 xl:gap-x-7 ml-auto mr-6 xl:mr-8"
...
//                         <Link
//                           to="/services"
//                           className="inline-flex items-center gap-1.5 text-xs font-bold text-domenion-blue hover:text-domenion-gold transition-colors"
...
//                               service.parentSlug
//                                 ? "ml-4 border-l-2 border-l-domenion-gold bg-domenion-gold/5"
//                                 : ""
//                             }`}
//                             onClick={() => setActiveDropdown(null)}
//                           >
...
//                             <ChevronRight
//                               size={15}
//                               className="text-domenion-blue/30 opacity-0 group-hover:opacity-100 group-hover:text-domenion-gold transition-all flex-shrink-0"
//                             />
//                           </Link>
//                         ))}
//                       </div>
...
//             <Link
//               to="/contact"
//               className="inline-flex items-center justify-center h-11 lg:h-12 px-4 sm:px-6 rounded-lg bg-domenion-gold text-white font-heading text-xs lg:text-[16px] font-extrabold tracking-wider uppercase hover:bg-domenion-gold-hover transition-colors shadow-sm no-underline text-decoration-none hover:translate-0.5 active:translate-y-0.5"
//             >
//               Request Quote
//             </Link>
      ...
      >
        <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8 h-20 lg:h-24 flex items-center justify-between">
          ...
          >
            ...
            <Link
              to="/"
              className={`relative h-12 flex items-center justify-center font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/")
                ? "text-white"
                : "text-white hover:text-domenion-gold"
                }`}
            >
            ...
            <Link
              to="/about"
              className={`relative h-12 flex items-center justify-center font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/about")
                ? "text-white"
                : "text-white hover:text-domenion-gold"
                }`}
            >
            ...
            >
              <Link
                to="/services"
                className={`relative h-12 flex items-center justify-center gap-1.5 font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/services") || activeDropdown === "services"
                  ? "text-white"
                  : "text-white hover:text-domenion-gold"
                  }`}
              >
                ...
                <ChevronDown
                  size={14}
                  className={`transition-transform duration-200 ${activeDropdown === "services"
                    ? "rotate-180 text-white"
                    : "text-white"
                    }`}
                />
              ...
              <AnimatePresence>
                {activeDropdown === "services" && (
                  ...
                  >
                    <motion.div
                      className="pointer-events-auto w-full max-w-[920px] max-h-[70vh] overflow-y-auto bg-white border border-domenion-gold/30 rounded-xl shadow-2xl p-4 text-domenion-blue"
                      variants={dropdownMenu}
                      initial="hidden"
                      animate="visible"
                      exit="exit"
                    >
                      <div className="flex items-center justify-between pb-2.5 mb-3 border-b border-neutral-border">
                        <span className="text-domenion-gold font-heading text-xs font-extrabold tracking-widest uppercase">
                          OUR SECURITY CAPABILITIES
                        </span>
                        <Link
                        ...
                        {services.map((service, index) => {
                          ...
                          return (
                            <Link
                              key={service.slug}
                              to={`/services/${service.slug}`}
                              className={`flex items-center gap-2.5 p-2.5 rounded-lg border transition-all duration-200 group min-h-[44px] ${isActive
                                ? "border-domenion-gold bg-domenion-gold/10 font-bold"
                                : "border-neutral-border/60 hover:border-domenion-gold/50 hover:bg-neutral-light"
                                }`}
                              onClick={() => setActiveDropdown(null)}
                            >
                              <span
                                className={`w-6 h-6 rounded-full font-heading text-[11px] font-extrabold flex items-center justify-center flex-shrink-0 ${isActive
                                  ? "bg-domenion-gold text-white"
                                  : "bg-domenion-gold/15 text-domenion-gold"
                                  }`}
                              >
                                {String(index + 1).padStart(2, "0")}
                              </span>
                              <span
                                className={`flex-1 font-heading text-sm truncate group-hover:text-domenion-gold ${isActive
                                  ? "text-domenion-gold font-bold"
                                  : "text-domenion-blue font-semibold"
                                  }`}
                              >
                                {service.title}
                              </span>
                              <ChevronRight
                                ...
                                className={`flex-shrink-0 transition-all ${isActive
                                  ? "text-domenion-gold opacity-100"
                                  : "text-domenion-blue/30 opacity-0 group-hover:opacity-100 group-hover:text-domenion-gold"
                                  }`}
                              />
                            </Link>
                          );
            ...
            >
              <Link
                to="/industries"
                className={`relative h-12 flex items-center justify-center gap-1.5 font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/industries") ||
                  activeDropdown === "industries"
                  ? "text-white"
                  : "text-white hover:text-domenion-gold"
                  }`}
              >
                ...
                <ChevronDown
                  size={14}
                  className={`transition-transform duration-200 ${activeDropdown === "industries"
                    ? "rotate-180 text-white"
                    : "text-white"
                    }`}
                />
            ...
            <Link
              to="/careers"
              className={`relative h-12 flex items-center justify-center font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/careers")
                ? "text-white"
                : "text-white hover:text-domenion-gold"
                }`}
            >
            ...
            <Link
              to="/contact"
              className={`relative h-12 flex items-center justify-center font-heading text-[16px] font-bold transition-colors duration-200 ${isCurrentRoute("/contact")
                ? "text-white"
                : "text-white hover:text-domenion-gold"
                }`}
            >
